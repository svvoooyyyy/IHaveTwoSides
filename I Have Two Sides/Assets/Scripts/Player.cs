...
public class Player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (_rb.velocity != Vector2.zero) { _animator.Play("Run"); } else { _animator.Play("Idle"); }
    ...
    public void Move(InputAction.CallbackContext context)
    {
        ...
        if (_moveDirection.x > 0) { _body.transform.localScale = new Vector3(-Mathf.Abs(_body.transform.localScale.x), _body.transform.localScale.y);
